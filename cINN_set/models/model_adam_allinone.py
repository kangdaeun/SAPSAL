...
class ModelAdamAllInOne(nn.Module):
...
#            INN = Ff.ReversibleGraphNet
        ...
        for i in range(c.n_blocks):
            nodes.append(Ff.Node([nodes[-1].out0], Fm.AllInOneBlock,
                                ...
                                'affine_clamping':c.affine_clamping,
                                'gin_block':c.gin_block,
                                'global_affine_init':c.global_affine_init,
                                'global_affine_type':c.global_affine_type,
                                'permute_soft':c.permute_soft,
                                'learned_householder_permutation':c.learned_householder_permutation,
                                'reverse_permutation':c.reverse_permutation
                                },
                                conditions = [nodes[0]],
                                name=F'coubpling_{i}'))
