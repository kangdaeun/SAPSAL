"""
v3 Vis-Net
Phoenix and FRAPPE combined. 
original: FpSpD_TGARsL_Noise_EfMS.pt of c_test_with_g
...
additional_kwarg = {'f_min_dic': {'A_V': 0.1}, 'R_V_noise_pdf': {'sampling': 'uniform', 'lsig_min': -5, 'lsig_max': -0.5} }
 
# name of output network, Ex) output/xxxx_network.pt
# Do not forget to make upper directory if you use
filename = 'v3_Vis_Net.pt'
 
# name (inculuding path) of database
tablename = 'Database/SpDpFRP_MUSE_2p18.parquet'
...
slab_grid = 'Database/Hslab_tau750_p15_MUSE.parquet' # Path to slab grid file (.csv)
